...
{
    //CHANGE THESE!
    private static string defaultWebhook = "https://discord.com/api/webhooks/";
    private static string defaultUserAgent = "Project Honeycomb";
    private static string defaultUserName = "On Deck Bot";
